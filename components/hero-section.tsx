      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-white/60 tracking-wide">Email Marketing Expert</span>
          </motion.div>
          ...
          <motion.div custom={2} variants={fadeUpVariants} initial="hidden" animate="visible">
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-12 leading-relaxed font-light tracking-wide max-w-2xl mx-auto px-4">
              Boost your revenue with data-driven email campaigns that convert. From strategy to execution, I help
              businesses unlock the full potential of email marketing.
            </p>
          </motion.div>
          ...
          >
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-3 rounded-full transition-all duration-300 group"
            >
              Get Started Today
